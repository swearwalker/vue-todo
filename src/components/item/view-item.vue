<template>
  <div class="item w-full md:w-1/2 px-2 my-4">
    <div class="item__wrapper bg-gradient-light px-4 pt-16 pb-4 rounded-lg flex flex-col items-start justify-end shadow-lg relative">
      ...
      <ul class="item__list comments w-full">
        <li @click="showModal" class="item w-full p-2 mb-2 rounded-lg shadow cursor-pointer">
          <h3 class="item__author font-bold text-sm text-primary">Додати коментар</h3>
        </li>
