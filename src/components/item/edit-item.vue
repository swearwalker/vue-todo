<template>
  <form class="form bg-white rounded-lg shadow-lg p-4 w-full md:w-1/3" @submit.prevent="updateNote">
    ...
    <button class="form__btn btn btn-primary" type="submit">Зберегти</button>
  </form>
</template>
